...
<!-- 	</div>
	<div class="row"> -->
		...
		<c:forEach items="${post}" var="postList">
			...
			<div class="col-4">
				<div class="card my-4">
					<a href="FindHobbyPostByNo.do?postNo=${postList.postNo}"><img src="assets/img/sprint.png" class="card-img-top"></a>
					<div class="card-body">
						<c:choose>
						...
						<h5 class="card-title"><a href="FindHobbyPostByNo.do?postNo=${postList.postNo}">${postList.title}</a></h5>
